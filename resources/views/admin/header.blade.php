                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        <th>ID</th>
                                        <th>Էջի ԱնվանումըAM</th>
                                        <th>Էջի ԱնվանումըRU</th>
                                        <th>Էջի ԱնվանումըEN</th>
                                        <th>Էջը</th>
                                        <th>Ձևափոխել</th>
                                        <th>Ջնջել</th>
                                    </tr>
                                    ...
                                    @isset($header)
                                        @foreach($header as $headers)
                                            <tr>
                                                <td>{{$headers->id}}</td>
                                                <td>{{$headers->pageNameAM}}</td>
                                                <td>{{$headers->pageNameRU}}</td>
                                                <td>{{$headers->pageNameEN}}</td>
                                                <td>{{$headers->page}}</td>
                                                <td>
                                                    <form  action="{{route('header.edit',$headers->id)}}" method="get" style="color: black;text-align: center">
                                                ...
                                                <td>
                                                    <form action="{{route('header.destroy',$headers->id)}}" method="post" style="color: black">
                                                        @csrf
                                                        @method('DELETE')
