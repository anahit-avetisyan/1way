        ...
        <div class="languageExchange">
            ...
            <div class="cont fade">
                <div class="languageContainer">
                    ...
                    <a style="display: flex;align-items: center" href="{{route("AM.sale",['curse'=>$curse])}}"><img src="{{URL::asset("images/flags/armenia.png")}}"  /> AM</a>
{{--                    <a style="display: flex;align-items: center" href="{{route("RU.sale",['curse'=>$curse])}}"><img src="{{URL::asset("images/flags/russia.png" )}}" /> RU</a>--}}
{{--                    <a style="display: flex;align-items: center" href="{{route("EN.sale",['curse'=>$curse])}}"><img src="{{URL::asset("images/flags/united-states.png")}}" /> EN</a>--}}
                    </div>
                </div>
                <div class="exchangeContainer">
                    ...
                    <form action="{{route('AM.sale',['curse'=>$curse])}}" role="search" method="get">
                        @csrf
    ...
    <div class="col-lg-10 col-12">
        <b>
            <h1>
                @foreach($text as $texts)
                    <h5 style="margin-top: -0.1%" class="salestr mb-5">
                        {{$texts->text1AM}}
                    </h5>
                @endforeach
            </h1>
        ...
        <span>
            ...
            <div class="row justify-content-between">
                @foreach ($productsSal as  $product)
                    ...
                    <div class="productItem mb-4">
                        <div>
                            ...
                            @endphp
                            <a href="{{ route('AM.single',["id"=>$product->id,"curse"=>$curse]) }}" title="{{$product->titleAM}}">
        ...
        <div style="display: flex;justify-content: flex-end;padding-right:14px"> {{$productsSal->links()}}</div>
    </div>
