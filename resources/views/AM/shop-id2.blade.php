        ...
        <div class="languageExchange">
            ...
            <div class="cont fade">
                <div class="languageContainer">
                    ...
                    <a style="display: flex;align-items: center" href="{{route("AM.shop-id2",['id'=>$name[0]->id,'curse'=>$curse])}}"><img src="{{URL::asset("images/flags/armenia.png")}}"  /> AM</a>
{{--                    <a style="display: flex;align-items: center" href="{{route("RU.shop-id2",['id'=>$name[0]->id,'curse'=>$curse])}}"><img src="{{URL::asset("images/flags/russia.png" )}}" /> RU</a>--}}
{{--                    <a style="display: flex;align-items: center" href="{{route("EN.shop-id2",['id'=>$name[0]->id,'curse'=>$curse])}}"><img src="{{URL::asset("images/flags/united-states.png")}}" /> EN</a>--}}
</div>
                </div>
                <div class="exchangeContainer">
                    ...
                    <form action="{{route('AM.shop-id2',['id'=>$name[0]->id,'curse'=>$curse])}}" role="search" method="get">
                        @csrf
                ...
                @if(count($ggg) > 0)
                    ...
                    <div class="productItem mb-4 mr-lg-4 mr-3">
                        <div>
                            ...
                            @endphp
                            <a href="{{ route('AM.single',[$rrr->id,"curse"=>$curse]) }}" title="{{$rrr->titleAM}}">
                                <div class="ItemSquare" style="background-image: url({{asset('images/'.$img[0])}});"></div>
                                <p style="color: black;" >{{mb_substr($rrr->titleAM,0,27).".."}}</p>
                                    ...
                                    <a href="{{ route('AM.single',[$rrr->id,"curse"=>$curse]) }}" title="{{$rrr->titleAM}}">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <span style="padding-left: 5px">
                                                <?php
                                                //===================================
                                                $ooo = $rrr->priceAM * $rrr->sale/100;

                                                $ttt = $rrr->priceAM - $ooo;
                                                //===================================
                                                $qqq = $rrr->priceRU * $rrr->sale/100;

                                                $eee = $rrr->priceRU - $qqq;
                                                //===================================
                                                $yyy = $rrr->priceEN * $rrr->sale/100;
                    ...
                    @endforeach
                        ...
                        @endif
{{--                    <div style="display: flex;justify-content: flex-end">{{$rrr->links()}}</div>--}}
            </div>
        </div>
    </div>
    <style>
