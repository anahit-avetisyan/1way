        ...
        <div class="languageExchange">
            ...
            <div class="cont fade">
                <div class="languageContainer">
                    ...
                    <a style="display: flex;align-items: center" href="{{route("AM.top",['curse'=>$curse])}}"><img src="{{URL::asset("images/flags/armenia.png")}}"  /> AM</a>
{{--                    <a style="display: flex;align-items: center" href="{{route("RU.top",['curse'=>$curse])}}"><img src="{{URL::asset("images/flags/russia.png" )}}" /> RU</a>--}}
{{--                    <a style="display: flex;align-items: center" href="{{route("EN.top",['curse'=>$curse])}}"><img src="{{URL::asset("images/flags/united-states.png")}}" /> EN</a>--}}
                    </div>
                </div>
                <div class="exchangeContainer">
                    ...
                    <form action="{{route('AM.top',['curse'=>$curse])}}" role="search" method="get">
                        @csrf
    ...
    <div class="col-lg-10 col-12">
        ...
        <span>
            <img src="{{URL::asset("images/filter.png")}}" alt="">
                ...
                <div class="row products ml-lg-1">
                    @foreach ($products as  $product)
                        ...
                        <div class="productItem mb-4 mr-lg-4 mr-3">
                            <div>
                                ...
                                @endphp
                                <a href="{{ route('AM.single',[$product->product_id,"curse"=>$curse]) }}" title="{{$product->titleAM}}">
            ...
            <div style="display: flex;justify-content: flex-end;padding-right:14px">{{$products->links()}}</div>
        </div>
    </div>
    </div>
    <style>
