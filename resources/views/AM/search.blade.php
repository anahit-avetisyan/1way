        ...
        <div class="languageExchange">
            ...
            <div class="cont fade">
                <div class="languageContainer">
                    ...
                    <a style="display: flex;align-items: center" href="{{route("AM.search",[$curse])}}"><img src="{{URL::asset("images/flags/armenia.png")}}"  /> AM</a>
{{--                    <a style="display: flex;align-items: center" href="{{route("RU.search",[$curse])}}"><img src="{{URL::asset("images/flags/russia.png" )}}" /> RU</a>--}}
{{--                    <a style="display: flex;align-items: center" href="{{route("EN.search",[$curse])}}"><img src="{{URL::asset("images/flags/united-states.png")}}" /> EN</a>--}}
                    </div>
                </div>
                <div class="exchangeContainer">
                    ...
                    <form action="{{route('AM.search',$curse)}}" role="search" method="get">
                        @csrf
