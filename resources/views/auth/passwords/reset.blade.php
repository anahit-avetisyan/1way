...
{{--        <div class="col-md-8">--}}
{{--            <div class="card">--}}
{{--                <div class="card-header">{{ __('Վերանկանգնել Գաղտնաբառը') }}</div>--}}
...
{{--                        <div class="form-group row">--}}
{{--                            <label for="password" class="col-md-4 col-form-label text-md-right">{{ __('Գաղտնաբաո') }}</label>--}}
...
{{--                        <div class="form-group row">--}}
{{--                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('Վերականգնել Գաղտնաբաոը') }}</label>--}}
